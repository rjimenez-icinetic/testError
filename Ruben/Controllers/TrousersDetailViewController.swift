//
//  TrousersDetailViewController.swift
//  Ruben
//
...
class TrousersDetailViewController: DataViewController<ProductsDSItem> {
	...
	override func viewDidLoad() {
		...
		textLabel2Button = createButton(Images.arrow)
...
extension TrousersDetailViewController: DataResponse {
    ...
    func success() {
        ...
        let contactViewControllerAction = NavigationPushAction(rootViewController: self, destinationViewController: contactViewController)
		
		setAction(contactViewControllerAction, view: textLabel2)
		setAction(contactViewControllerAction, view: textLabel2Button)
