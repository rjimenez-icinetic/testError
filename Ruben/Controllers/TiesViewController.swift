...
class TiesViewController: TableViewController<ProductsDSItem>, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        AnalyticsManager.sharedInstance?.analytics?.logPage("Ties")
       
	    navigationItem.title = NSLocalizedString("Ties", comment: "")
	
        datasourceOptions = DatasourceOptions()
        datasourceOptions.addDesignFilter(datasource?.datasourceFilter.create(ProductsDSItemMapping.category, string: "Ties"))
			

        tableView.dataSource = self
        tableView.delegate = self
        tableView.registerClass(Cell.self, forCellReuseIdentifier: Cell.identifier)
		behaviors.append(FilterBehavior<TiesFilterViewController>(viewController: self))
		behaviors.append(SearchBehavior(viewController: self))
		behaviors.append(CreateBehavior<TiesFormViewController, ProductsDSItem>(viewController: self))
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let destinationViewController = TiesDetailViewController()
...
extension TiesViewController: DataResponse {
