//
//  JacketsDetailViewController.swift
//  Ruben
//
...
class JacketsDetailViewController: DataViewController<CloudantDSSchemaItem> {
	...
	override func viewDidLoad() {
		...
		behaviors.append(UpdateBehavior<JacketsFormViewController, CloudantDSSchemaItem>(dataViewController: self))
...
extension JacketsDetailViewController: DataResponse {
